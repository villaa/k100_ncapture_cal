...
./condork100Sim_GenericShielding -n 10 -src DDCoin -set 34 -ngen 10000000 -template templates/n2-45MeVCoin.mac.template -merge -sourcepos -50.0 0.0 0.0 -shieldsize 40.0 40.0 20.0 -shieldmat Poly -exe
