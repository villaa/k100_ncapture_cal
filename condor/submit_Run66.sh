...
./condork100Sim_GenericShielding -n 1 -src PuBe -set 3 -ngen 1000000 -template templates/Run66Shield_nearCryostat.mac.template -merge -sourcepos 23.348 23.348 0.0 -shieldsize 40.0 40.0 40.0 -shieldmat Poly -tagname Sim4 -exe
