...
#standard R66 config, neutrons from PuBe in barrel
#Simulation 2 has increased Poly density
#parameters for shieldmat and shieldsize are irrelevant because the
#template doesn't use the generic shield setup
./condork100Sim_GenericShielding -n 10 -src PuBe -set 1 -ngen 1000000 -template templates/Run66Sim2Shield_stdLocation_inBarrel.mac.template -merge -sourcepos 0.0 119.731 -64.679 -shieldsize 40.0 40.0 40.0 -shieldmat Poly -exe
./condork100Sim_GenericShielding -n 10 -src PuBe -set 2 -ngen 1000000 -template templates/Run66Sim2Shield_stdLocation_outBarrel.mac.template -merge -sourcepos 0.0 119.731 -64.679 -shieldsize 40.0 40.0 40.0 -shieldmat Poly -exe
